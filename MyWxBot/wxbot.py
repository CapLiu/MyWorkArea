...
class WXBot:
    ...
    def get_contact(self):
        ...
        for i in range(0,len(self.special_list)):
            print unicode(self.special_list[i]['NickName'])
        return True
    ...
    def get_user_id(self, name):
        ...
        for special in self.special_list:
            if 'RemarkName' in special and special['RemarkName'] == name:
                return special['UserName']
            if 'NickName' in special and special['NickName'] == name:
                return special['UserName']
            if 'DisplayName' in special and special['DisplayName'] == name:
                return special['UserName']
